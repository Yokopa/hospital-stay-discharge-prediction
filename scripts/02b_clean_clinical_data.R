...
print(age_errors) 
  # one row, principal_diagnosis:  P20.9 (Intrauterine hypoxia, unspecified)
...
print(patient_negative_age)
  # no other cases for that patient
...
#===============================================================================
summary(clinical_data_cleaned)
str(clinical_data_cleaned)

#===============================================================================
# 4. Save the cleaned clinical data
#===============================================================================
write.csv(clinical_data_cleaned, cleaned_clinical_data_path, row.names = FALSE)
